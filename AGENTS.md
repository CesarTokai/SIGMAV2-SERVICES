...
## NOTA Y REGLA MUY IMPORTANTE:

DAR TEXTOS RESUMIDOS EN LA CONVERSACION , NO REALIZAR ARCHIVOS MD O PDF , O ESCRITOS LARGOS , SOLO RESPONDER CON RESUMENES O EXTRACTOS DE INFORMACION CLAVE , SI SE REQUIERE INFORMACION DETALLADA O COMPLETA , SOLICITARLA DE MANERA ESPECIFICA Y SE PROPORCIONARA EN PARTES O SECCIONES CLAVE.
