...
const handleConteo1KeyPress = (event: KeyboardEvent) => {
  if (event.key === 'Enter') {
    ...
    if (conteo1Input.value !== null) { guardarConteo(); }
  }
};
...
const handleConteo2KeyPress = (event: KeyboardEvent) => {
  if (event.key === 'Enter') {
    event.preventDefault();
    event.stopImmediatePropagation();
    if (conteo2Input.value !== null) { guardarConteo(); }
  }
};
...
.diferencia-neutral { background: #f3f4f6; color: #6b7280; border: 1px solid #d1d5db; }
.diferencia-igual { background: #d1fae5; color: #065f46; border: 1px solid #6ee7b7; font-weight: 700; box-shadow: 0 2px 4px rgba(6, 95, 70, 0.2); }
.diferencia-positiva { background: #fef3c7; color: #92400e; border: 1px solid #fcd34d; font-weight: 700; box-shadow: 0 2px 4px rgba(146, 64, 14, 0.2); }
.diferencia-negativa { background: #fee2e2; color: #991b1b; border: 1px solid #fca5a5; font-weight: 700; box-shadow: 0 2px 4px rgba(153, 27, 27, 0.2); }
