...
const generarMarbetes = async () => {
  ...
  const result = await Swal.fire({
    ...
    html: `
      <div style="text-align: left;">
        ...
        <p><strong>Productos:</strong> ${validation.message}</p>
      </div>
    `,
    icon: 'question',
    showCancelButton: true,
  ...
  try {
    ...
    console.log('📤 Generando marbetes:', { total: products.length, body });
...
// ============================================
// FASE 4 - Búsqueda server-side mejorada con debounce
// ============================================
